...
describe('routes using array of routers', () => {
  beforeAll(() => {
    ...
    */
    ...
    routeTree = [...component.find(Route), ...component.find(AuthRoute)].reduce(
      (paths, route) => {
        ...
        if (
          ...
          route.type.name === 'AuthRoute'
        ) {
          routeTree.protectedRoute[routeProps.path] = {
            generalComponent_HOC_Method: routeProps.component,
          };
          /* ----Above ---
  ...
  it('should show AboutProtected component from AuthRoute and path /admin', () => {
    ...
    const comp = routeTree.protectedRoute['/about'].generalComponent_HOC_Method(
      routesParams['/about']
    ).type;
  ...
  it('should show SiteProtected component from AuthRoute and path /site', () => {
    const comp = routeTree.protectedRoute['/site'].generalComponent_HOC_Method(
      routesParams['/site']
    ).type;
