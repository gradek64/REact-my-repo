import { createUserAccountServiceResponseData } from './CreateUserAccountResponseData'
import { SessionResponseStub, SerialisableStubObject } from 'types/stubs'

class CreateUserAccountService implements SerialisableStubObject<SessionResponseStub> {
  private _response: SessionResponseStub['response']
  private _responseType: SessionResponseStub['responseType']

  setDefaults() {
    this.updateCreateUserAccountServiceResponse(createUserAccountServiceResponseData.UserRegistered)
  }
  ...
  updateCreateUserAccountServiceResponse({ response }: { response: SessionResponseStub['response'] }) {
