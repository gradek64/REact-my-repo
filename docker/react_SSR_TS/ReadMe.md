...
this app is using Navbar that have

import { NavLink } from 'react-router-dom'

then in Grid Component we have a logic that knows if you require link from client or from server

<a> tag it would be used for server site render and Link used for Client in the Redux version of this Repo MODE_AND_CLIENT_SSR_WITH_REDUX
